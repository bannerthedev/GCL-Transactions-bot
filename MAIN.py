...
# ---------------- CONFIG (fill these) ----------------
GUILD_ID = 1460452082262737049  # your guild/server ID

# channels
# channels
TRANSACTIONS_ID = 1536116314601689108
MATCH_TIMES_CHANNEL_ID = 1495034456497586386
ASSIGNMENTS_CHANNEL_ID = 1545853863658000516
SCRIM_CATEGORY_ID = 1537580436774191226  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1495034735976648777  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1545868214976778361
CO_CAPTAIN_ROLE_ID = 1545868185209933995
EXECUTIVE_ROLE_ID = 1545868234824351824
TEAM_PLAYER_ROLE_ID = 1545868155132321842

# assignment roles
HEAD_REF_ROLE_ID = 1545868424750698687
REF_ROLE_ID = 1525125964823269538
HEAD_CASTER_ROLE_ID = 1545868406874710076
CASTER_ROLE_ID = 1525126196772474890
# ----------------------------------------------------
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="GCL Transactions Bot – Admin Command Guide",
...
async def standing(interaction: discord.Interaction):
    ...
    lines_out = ["Gorilla Competitive League SEEDING"]
    rank = 1
